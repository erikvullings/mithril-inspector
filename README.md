...
The packages under \`packages/\` are strict TypeScript, modern ESM modules. Playground applications live under \`apps/\`, while shared fixtures and integration suites live under \`tests/\`.
